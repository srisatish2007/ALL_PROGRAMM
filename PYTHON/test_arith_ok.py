...
def Creating_list():
    ...
    for i in big_disp_text2:
        ...
        if i != "*" and i != "-" and i != "/" and i != "+" and i != "=" and i != "^" and i!="sin<" and i!="cos<" and i!="tan<":
...
button_sci_logrithm = CTkButton(
    ...
    fg_color=orange,
    corner_radius=23,
    font=("Helvetica 24 bold", f-3.5, "bold"),).place(x=17.9,y=289.5)
...
button_sci_equal = CTkButton(
    ...
    fg_color=orange,
    corner_radius=23,
    font=("Helvetica 24 bold", f+10, "bold"),).place(x=199.4,y=289.5)
